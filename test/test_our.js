...
const OUR = artifacts.require('OUR');

contract('OUR', function (accounts) {
    const [ initialHolder, recipient, anotherAccount ] = accounts;

    const TOKEN_NAME = 'OUR';
    const TOKEN_SYMBOL = 'OUR';
    const TOKEN_DECIMAL = new BN(18);
    const INITIAL_SUPPLY = new BN(1000000000); // 1000000000000000000000000000
    ...
    beforeEach(async function () {
        this.token = await OUR.new(TOKEN_NAME, TOKEN_SYMBOL, INITIAL_SUPPLY);
    });
